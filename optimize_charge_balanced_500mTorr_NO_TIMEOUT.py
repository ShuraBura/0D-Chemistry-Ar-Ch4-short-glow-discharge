...
def run_simulation(rate_values, Te, ne, E_field, params_base, log_file=None):
    ...
    try:
        ...
        # CRITICAL: Start from known good transient state from best_f78.3.json
        # These values lead to HIGH steady state when integrated further
        set_density('e', ne)
        set_density('Ar', n_Ar)
        set_density('CH4', n_CH4)
        set_density('ArPlus', 2.94e+08)
        set_density('CH4Plus', 1.71e+09)
        set_density('CH3Plus', 1.90e+08)
        set_density('CH5Plus', 2.60e+09)
        set_density('ArHPlus', 2.17e+08)
        set_density('CH3Minus', 1.57e+05)
        set_density('H2', 3.04e+13)
        set_density('ArStar', 1.36e+09)
        set_density('H', 1.02e+13)
        set_density('C2', 2.64e+10)
        set_density('CH', 2.44e+09)
        set_density('C2H4', 1.88e+11)
        set_density('C2H6', 2.67e+12)
        set_density('CH2', 6.24e+11)
        set_density('C2H2', 1.38e+12)
        set_density('C2H5', 2.92e+11)
        set_density('CH3', 1.55e+13)
        set_density('C', 1.26e+10)
        set_density('H3Plus', 1.89e+06)
        set_density('C2H3', 1.97e+09)
        set_density('C3H2', 3.37e+08)
        set_density('CHPlus', 4.01e+02)
        set_density('C3H', 2.05e+08)
        set_density('C4H2', 2.28e+04)
        set_density('C2H', 5.18e+08)
        set_density('C3H3', 2.15e+05)
        set_density('C3H4', 1.95e+07)
        set_density('C3', 2.18e+08)
        set_density('C3H5', 7.15e+07)
        set_density('C4H', 5.80e+04)
        set_density('C3H6', 6.31e+08)
        set_density('CH2Plus', 4.22e+05)
        set_density('C2H5Plus', 1.22e+09)
        set_density('C2H4Plus', 5.06e+04)
        set_density('C2H3Plus', 3.37e+04)
        set_density('HMinus', 6.01e+08)
        set_density('C2HPlus', 2.40e+05)
        set_density('H2Plus', 9.40e+07)
        set_density('C2H2Star', 7.32e+07)
