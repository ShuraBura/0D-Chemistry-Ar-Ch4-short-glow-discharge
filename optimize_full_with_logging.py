#!/usr/bin/env python3
"""
Full 32-parameter optimization with comprehensive logging.

Logs for each iteration:
- All species densities
- Reaction breakdown for H, CH, C2, and important species
- Parameter values
- Objective function value

This allows post-analysis to find optimal parameter set.
"""
...
def objective_function(x, param_names, params_base):
    ...
    if error < best_result['objective']:
        ...
        log_file = f'optimization_results/best_iteration_{iteration_counter:04d}_f{error:.1f}.json'
...
def main():
    ...
    print("=" * 80)
    print("\nDetailed logs will be saved to optimization_results/")
    ...
    with open('optimization_results/FINAL_RESULT.json', 'w') as f:
        json.dump({
    ...
    print(f"\n✓ Final parameters saved to optimization_results/FINAL_RESULT.json")
    print(f"✓ Best result logs saved to optimization_results/best_iteration_*.json")
