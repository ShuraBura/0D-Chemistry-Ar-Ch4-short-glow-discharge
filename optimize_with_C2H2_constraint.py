#!/usr/bin/env python3
"""
OPTIMIZATION WITH C2H2 CONSTRAINT - Enables C2 Production Pathway
...
This version adds large penalty if C2H2 < 5e+12, forcing optimizer
to find conditions where the C2 production pathway is active.
"""
...
# Create results directory for C2H2-constrained version
os.makedirs('optimization_results_C2H2_constrained', exist_ok=True)
...
def objective_function(x, param_names, params_base):
    ...
    if total_error < best_result['objective']:
        ...
        log_file = f'optimization_results_C2H2_constrained/best_f{total_error:.1f}.json'
